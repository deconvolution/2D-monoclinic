...
[a1,b1]=meshgrid(1:lp+1,1:nz);
[a2,b2]=meshgrid(nx-(lp+1)+1:nx,1:nz);
[a3,b3]=meshgrid(1:nx,1:lp+1);
[a4,b4]=meshgrid(1:nx,nz-(lp+1)+1:nz);
IND_air_layer=sub2ind([nx,nz],[reshape(a1,[1,(lp+1)*nz]),reshape(a2,[1,(lp+1)*nz]),reshape(a3,[1,(lp+1)*nx]),reshape(a4,[1,(lp+1)*nx])],...
    [reshape(b1,[1,(lp+1)*nz]),reshape(b2,[1,(lp+1)*nz]),reshape(b3,[1,(lp+1)*nx]),reshape(b4,[1,(lp+1)*nx])]);
